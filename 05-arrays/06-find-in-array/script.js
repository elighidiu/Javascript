...
(function() {
    ...
    document.getElementById("run").addEventListener ("click", function() {
      ...
      var pers = people.find ((element) => 

           /* se foloseste asa cand avem doar un statment
           element.lastname == "Dupont" && element.firstname == "Jean");
           */

           {
               if (element.lastname == "Dupont" && element.firstname == "Jean") {
                return element; /* dc folosesc fat arrow cu {} atunci trebuie sa folosesc return. In prima varainta e implied returned. */
               }
